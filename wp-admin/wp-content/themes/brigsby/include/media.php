...
function hoot_theme_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		// 	'label'          => __( 'Small Thumbnail', 'brigsby' ),
		// 	'width'          => 315,
		// 	'height'         => 215,
		// 	'crop'           => true,
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'brigsby' ),
			'width'          => 420, // 240 x 165
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'brigsby' ),
			'width'          => 550,
			'height'         => 250,
			'crop'           => true,
			'show_in_editor' => false,
