...
$searchlabel = apply_filters( 'hoot_search_form_label', __( 'Search', 'brigsby' ) );
$searchplaceholder = apply_filters( 'hoot_search_form_placeholder', __( 'Type Search Term...', 'brigsby' ) );
$searchsubmit = apply_filters( 'hoot_search_form_submit', __( 'Search', 'brigsby' ) );
